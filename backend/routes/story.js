...
async function generateStory(prompt) {
    try {
        const response = await axios.post(
            ...
            { 
                // inputs: prompt
                inputs: `Write a complete, engaging, and suitable children's story with minimum word count 200 and having a begginig middle alimax and ending based on: "${prompt}"`
            },
            {
                headers: { 
        ...
        story = story.replace(`Write a complete, engaging, and suitable children's story with minimum word count 200 and having a begginig middle alimax and ending based on: "${prompt}"\n`, '');
